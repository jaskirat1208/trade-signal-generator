...
Solution bug fixes: 
- Last price was not being updated, so, duplicate entries were being printed that led to ~61k entries. Added a line last_price = price right before the price recalculation
- Tick size rounding was not appropriate
- Writing to a file in read mode.
'''
